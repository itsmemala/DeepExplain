...
# Replacing for TF2 compatibility
...
class AttributionMethod(object):
    ...
    def __init__(self, T, X, session, keras_learning_phase=None):
        ...
        print("AttributionMethod init - 1.")
        self.T = T  # target Tensor
        print("AttributionMethod init - 2.")
        self.X = X  # input Tensor
        print("AttributionMethod init - 3.")
        self.Y_shape = [None,] + T.get_shape().as_list()[1:]
        print("AttributionMethod init - 4.")
...
# Replacing for TF2 compatibility
        ...
        print("At the end of AttributionMethod init.")
...
#    def __init__(self, graph=None, session=tf.get_default_session()):
    def __init__(self, graph=None, session=tf.compat.v1.InteractiveSession()):
        self.method = None
